...
import static edu.com.google.maps.internal.StringJoin.join;

import edu.com.google.maps.internal.ApiConfig;
import edu.com.google.maps.model.AddressType;
import edu.com.google.maps.model.ComponentFilter;
import edu.com.google.maps.model.GeocodingResult;
...
public class GeocodingApiRequest
  ...
  public GeocodingApiRequest bounds(LatLng southWestBound, LatLng northEastBound) {
    return param("bounds", StringJoin.join('|', southWestBound, northEastBound));
  }
  ...
  public GeocodingApiRequest components(ComponentFilter... filters) {
    return param("components", StringJoin.join('|', filters));
  }
  ...
  public GeocodingApiRequest resultType(AddressType... resultTypes) {
    return param("result_type", StringJoin.join('|', resultTypes));
  }
  ...
  public GeocodingApiRequest locationType(LocationType... locationTypes) {
    return param("location_type", StringJoin.join('|', locationTypes));
  }
}
